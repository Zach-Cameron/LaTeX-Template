...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% The following list summarizes the types of structures which are normally associated with 
% each theorem style:
%
% plain: Theorem, Lemma, Corollary, Proposition, Conjecture, Criterion, Assertion
% definition: Definition, Condition, Problem, Example, Exercise, Algorithm, Question, 
