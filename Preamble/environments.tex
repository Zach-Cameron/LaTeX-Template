%%% The following environments adhere to style conventions presented 
%%% in the documentation of the amsthm package:
...
% definition: Definition, Condition, Problem, Example, Exercise, Algorithm, Question, Axiom, 
%             Property, Assumption, Hypothesis
% remark: Remark, Note, Notation, Claim, Summary, Acknowledgment, Case, Conclusion
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% These default settings are provided:
%
...
%%%%%%%%
\theoremstyle{break}
\theoremheaderfont{\kern-1em\itshape}
\theorembodyfont{}
\theoremseparator{}
\theorempreskip{1em}
\theorempostskip{0em}
